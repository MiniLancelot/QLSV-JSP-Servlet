...
<html>
<head>
    <title>Xoá nhiều sinh viên</title>
    <style>
        td{
            text-align: center;
        }
    ...
    <form action="StudentController" method="post">
        <table border="1" width="100%">
            ...
            <tr>
                ...
                <td><input type="checkbox" name="selectedStudents" value="<%= StudentList.get(i).getId() %>"></td>
            </tr>
            <%}%>
            <tr><td><button type="submit" name="message" value="DeleteSelected">Delete</button></td></tr>
        </table>
    </form>
